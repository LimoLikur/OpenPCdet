    ...
    def __init__(self, root_path, sampler_cfg, class_names, logger=None):
        ...
        for db_info_path in sampler_cfg.DB_INFO_PATH:
            ...
            if not db_info_path.exists():
                ...
                if 'DB_INFO_PATH' not in sampler_cfg:
                    sampler_cfg.DB_INFO_PATH = sampler_cfg.BACKUP_DB_INFO['DB_INFO_PATH']
                else:
                    sampler_cfg.DB_INFO_PATH[0] = sampler_cfg.BACKUP_DB_INFO['DB_INFO_PATH'][0]

                if 'DB_DATA_PATH' not in sampler_cfg:
                    sampler_cfg.DB_DATA_PATH = sampler_cfg.BACKUP_DB_INFO['DB_DATA_PATH']
                else:
                    sampler_cfg.DB_DATA_PATH[0] = sampler_cfg.BACKUP_DB_INFO['DB_DATA_PATH'][0]
